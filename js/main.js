$(document).ready(function(){
    ...
    // d60d66c16508111d14d74e877d84c91f (토큰)
    
    // https://api.openweathermap.org/data/2.5/weather?q=seoul&appid=d60d66c16508111d14d74e877d84c91f

    var cityName = []; // 버튼 클릭시 또는 검색바에서 입력 후 엔터를 누를 시, 도시명 데이터를 수집한다
    console.log(cityName); // []

    var myAPI = `d60d66c16508111d14d74e877d84c91f`;

    var state_icon = ""; // 텍스트 아이콘을 이미지 아이콘으로 변경 할 수 있는 데이터
        ...
        $("#weather ul li").each(function(index){
            ...
            $.ajax({
                ...
                console.log(data);
                    ...
                    // 텍스트화 된 날씨를 (변수명 weather) 데이터 이미지를 이미지 아이콘으로 변경
    ...
    navigator.geolocation.getCurrentPosition(function(position){
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                w_info(); // 함수문을 호출한다 -> 배열 데이터의 개수에 따라 구조를 구정하고 그 데이터에 내용을 넣겠다는 의미
